...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative flex flex-col-reverse lg:flex-row items-center justify-center h-screen px-6 lg:px-24 bg-background overflow-hidden">
        {/* Left */}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 flex justify-center">
            <img
              ...
              className="w-[30rem] md:w-[40rem] object-contain"
            />
          </div>
